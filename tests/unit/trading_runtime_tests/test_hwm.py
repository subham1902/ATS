...
def test_initial_hwm_no_profit() -> None:
    state = evaluate_hwm(
        config=HWMConfig(), previous=None, session_start_equity=Decimal("100000"), current_equity=Decimal("100000")
    )
...
def test_peak_tracks_profit() -> None:
    ...
    s1 = evaluate_hwm(
        config=HWMConfig(), previous=s0, session_start_equity=Decimal("100000"), current_equity=Decimal("102000")
    )
...
def test_drawdown_deescalation_hint() -> None:
    ...
    s0 = evaluate_hwm(
        config=cfg, previous=None, session_start_equity=Decimal("100000"), current_equity=Decimal("110000")
    )
    s1 = evaluate_hwm(
        config=cfg, previous=s0, session_start_equity=Decimal("100000"), current_equity=Decimal("107000")
    )
...
def test_noise_floor_suppresses_tiny_giveback() -> None:
    ...
    s0 = evaluate_hwm(
        config=cfg, previous=None, session_start_equity=Decimal("100000"), current_equity=Decimal("101000")
    )
    s1 = evaluate_hwm(
        config=cfg, previous=s0, session_start_equity=Decimal("100000"), current_equity=Decimal("100950")
    )
